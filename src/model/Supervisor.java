...
public class Supervisor {
    ...
    public Supervisor(int id, String nome) {
        this.id = id;
        this.nome = nome;
    }
    ...
    public Supervisor(int id, String nome, String cpf, String rg, String titulacao, String telefone, String email, boolean status, Date dataEntrada) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.rg = rg;
