...
public class OrientadorDAO {
    ...
    public List<Orientador> listarTodos() throws SQLException {
        String sql = "SELECT * FROM orientador o, endereco e, contabancaria cb WHERE o.idEndereco = e.idEndereco AND o.idContaBancaria = cb.idContaBancaria ORDER BY o.nome";
